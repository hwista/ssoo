  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-sm">새 댓글 알림</span>
            <Button variant="outline" size="sm">활성</Button>
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            <span className="text-sm">멘션 알림</span>
            <Button variant="outline" size="sm">활성</Button>
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            <span className="text-sm">팔로우 알림</span>
            <Button variant="outline" size="sm">활성</Button>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-sm">이메일 공개</span>
            <Button variant="outline" size="sm">비공개</Button>
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            <span className="text-sm">스킬맵 공개</span>
