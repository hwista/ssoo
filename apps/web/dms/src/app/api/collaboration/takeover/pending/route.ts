...
export async function GET(req: Request) {
  ...
  const response = await fetch(
    createServerApiUrl(`/dms/collaboration/takeover/pending?path=${encodeURIComponent(path)}`),
