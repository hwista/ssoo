        ...
        <div className="rounded-lg border bg-card overflow-x-auto">
          <Table className="w-full text-sm">
            <TableHeader className="border-b bg-muted/40">
              <TableRow>
                <TableHead className="px-4 py-2 text-left font-medium">SHA</TableHead>
                <TableHead className="px-4 py-2 text-left font-medium">날짜</TableHead>
                <TableHead className="px-4 py-2 text-left font-medium">작성자</TableHead>
                <TableHead className="px-4 py-2 text-left font-medium">메시지</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {historyLoading ? (
                ...
                history.items.map((entry) => (
                  <TableRow key={entry.hash} className="border-b last:border-b-0">
                    <TableCell className="px-4 py-2 font-mono text-xs">{entry.hashShort}</TableCell>
                    <TableCell className="px-4 py-2 text-xs text-muted-foreground">{entry.date}</TableCell>
                    <TableCell className="px-4 py-2 text-xs">{entry.author}</TableCell>
                    <TableCell className="px-4 py-2 text-xs">{entry.message}</TableCell>
                  </TableRow>
                ))
              ) : (
                <TableRow>
