      ...
      <div className="rounded-lg border bg-card overflow-x-auto">
        <Table className="w-full text-sm">
          <TableHeader className="border-b bg-muted/40">
            <TableRow>
              <TableHead className="px-4 py-2 text-left font-medium">키</TableHead>
              <TableHead className="px-4 py-2 text-left font-medium">경로</TableHead>
              <TableHead className="px-4 py-2 text-left font-medium">스코프</TableHead>
              <TableHead className="px-4 py-2 text-left font-medium">종류</TableHead>
              <TableHead className="px-4 py-2 text-left font-medium">상태</TableHead>
          ...
          <TableBody>
            {isLoading ? (
              ...
              result.items.map((tpl) => (
                <TableRow key={tpl.templateId} className="border-b last:border-b-0">
                  <TableCell className="px-4 py-2 font-mono text-xs">{tpl.templateKey}</TableCell>
                  <TableCell className="px-4 py-2 font-mono text-xs">{tpl.relativePath}</TableCell>
                  <TableCell className="px-4 py-2">{tpl.templateScopeCode}</TableCell>
                  <TableCell className="px-4 py-2 font-mono text-xs">{tpl.templateKindCode}</TableCell>
                  <TableCell className="px-4 py-2 font-mono text-xs">{tpl.templateStatusCode}</TableCell>
                  ...
                  <TableCell className="px-4 py-2 font-mono text-xs">{tpl.ownerRef}</TableCell>
