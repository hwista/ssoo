...
const STORAGE_KEY = 'sns-user-settings';
...
function loadSettings(): SnsSettings {
...
export function SettingsPage() {
  const [settings, setSettings] = useState<SnsSettings>(DEFAULTS);
  ...
  const toggle = useCallback((key: keyof SnsSettings) => {
    setSettings((prev) => {
