...
- DMS: `docs/dms/AGENTS.md`, `.github/instructions/dms.instructions.md`, `.codex/instructions/dms.instructions.md`
- 문서 맵: `references/doc-map.md`

3. 코드 수정 + 문서 동기화
- 코드 변경 시 해당 도메인 문서(`docs/` 또는 `docs/dms/`)의 backlog/changelog 반영 여부 확인
