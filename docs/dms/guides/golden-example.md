...
### `components/pages/markdown/_components/editor/**`

- 현재 markdown editor runtime 정본 위치입니다.
- block editor/runtime 은 아직 `common` 으로 승격하지 않고 page-local support 로 유지합니다.

대표 예시:

- [Editor.tsx](/home/a0122024330/src/ssoo/apps/web/dms/src/components/pages/markdown/_components/editor/Editor.tsx)
- [BlockEditor.tsx](/home/a0122024330/src/ssoo/apps/web/dms/src/components/pages/markdown/_components/editor/block-editor/BlockEditor.tsx)
...
- page-local editor: [BlockEditor.tsx](/home/a0122024330/src/ssoo/apps/web/dms/src/components/pages/markdown/_components/editor/block-editor/BlockEditor.tsx)
...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-03-23 | page-local editor runtime 기준으로 현행화 |
