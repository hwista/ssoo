...
- Next.js의 optional image runtime이 요구하는 `sharp`는 취약한 `<0.35.4` 요청을 검증된 `0.35.4`으로 override합니다. 변경 시 5개 웹 production build와 Linux native image 변환 smoke를 함께 통과시킵니다.
