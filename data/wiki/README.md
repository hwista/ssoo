...
우선 ai 챗에 페이지![image](_assets/images/a3769f884d4b369d6b649ba5cb0eb86d81baf6120e5226a5eb0a18da5cb84672.png) 모드에서 새 세션 열기 프롤팅 버튼 고정으로 변경하고
채팅 생성 시 스크롤 하단으로 따라 가야하고, 그 상태에서 스크롤 올리면 그만 따라가고 스크롤 올릴때 밑으로 가는 버튼 추가ㅇ
ai 챗에 마크다운 양식은 마크다운 렌더러로 보여주면 됨. 무조건 마크다운 방식으로 챗할거면 무조건 렌더링 하면 되겠다.
