-- =========================================================
-- CMS Seed Data: Default Boards
-- Schema: cms
-- =========================================================

-- 기본 게시판 생성
INSERT INTO cms.cms_board_m (board_code, board_name, board_type, description, sort_order, is_default, is_active, created_at, updated_at)
VALUES
