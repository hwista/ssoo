-- =========================================================
-- History Trigger: cms.cms_post_m -> cms.cms_post_h
-- Schema: cms
-- =========================================================

CREATE OR REPLACE FUNCTION fn_cms_post_h_trigger()
RETURNS TRIGGER AS $$
DECLARE
...
BEGIN
  ...
  INSERT INTO cms.cms_post_h (
    ...
    v_record.visibility_scope_code, v_record.target_org_id,
...
DROP TRIGGER IF EXISTS trg_cms_post_h ON cms.cms_post_m;
CREATE TRIGGER trg_cms_post_h
AFTER INSERT OR UPDATE OR DELETE ON cms.cms_post_m
FOR EACH ROW EXECUTE FUNCTION fn_cms_post_h_trigger();
COMMENT ON FUNCTION fn_cms_post_h_trigger() IS '게시글 마스터 히스토리 트리거 함수';
